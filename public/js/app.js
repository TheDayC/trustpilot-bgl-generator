...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_nav__ = __webpack_require__(9);
...
$(document).ready(function () {
  ...
  var Navigation = new __WEBPACK_IMPORTED_MODULE_0__classes_nav__["a" /* default */]();
...
var Nav = function () {
  ...
  _createClass(Nav, [{
    ...
    value: function dropdown() {
      var element = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : ".dropdown-button";
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_validation__ = __webpack_require__(12);

var checkPassVal = new __WEBPACK_IMPORTED_MODULE_0__classes_validation__["a" /* default */](6, "valid", "invalid");
...
var Validation = function () {
  function Validation() {
    var password_length = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 6;
    var valid_class = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : "valid";
    var invalid_class = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : "invalid";
  ...
  _createClass(Validation, [{
    key: "passwordLength",
    value: function passwordLength(field_one, field_two, on_event) {
      var password_length = this.password_length;
      var valid_class = this.valid_class;
      var invalid_class = this.invalid_class;
    ...
    key: "passwordConfirmLength",
    value: function passwordConfirmLength(field_one, field_two, on_event) {
      var password_length = this.password_length;
      var valid_class = this.valid_class;
      var invalid_class = this.invalid_class;
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__classes_repeater__ = __webpack_require__(14);

var PayloadRepeater = new __WEBPACK_IMPORTED_MODULE_0__classes_repeater__["a" /* default */]();
...
if ($("#payload-repeater").length) {
  ...
  var field_data = [{ "name": "uid", "placeholder": "ID", "type": "text" }, { "name": "name", "placeholder": "Name", "type": "text" }, { "name": "email", "placeholder": "Email", "type": "email" }];
...
var Repeater = function () {
  ...
  _createClass(Repeater, [{
    key: "addRow",
    value: function addRow(container_id, field_data, row_class, before) {
      // Generate row html
      var row_html = this.createRowHtml(container_id, row_class, field_data);
    ...
    key: "createRowHtml",
    value: function createRowHtml(container_id, row_class) {
      var field_data = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : [];
      ...
      if (field_data.length) {
        ...
        field_data.forEach(function (element, index) {

          if (index % 3 === 0 && index !== 0) {
            row_html += '</div>';
          }
          if (index % 3 === 0 || index === 0) {
            row_html += '<div class="input-collection col s12 no-gutter">';
          }
